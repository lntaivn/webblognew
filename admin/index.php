...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        $sql = "SELECT date(date) as week, COUNT(*) as post_count FROM blog WHERE YEAR(date) = YEAR(CURDATE()) GROUP BY WEEK(date)";
                        $result = $kn->query($sql);

                        $weekly_posts = [];
                        while ($row = $result->fetch_assoc()) {
                            $weekly_posts[$row['week']] = $row['post_count'];
                        }

                        // Chuyển mảng PHP sang JSON
                        $weekly_posts_json = json_encode($weekly_posts);
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            var data = <?php echo $weekly_posts_json; ?>;
